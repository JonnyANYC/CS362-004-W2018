                         ...
                         int drawntreasure)
{
  ...
  while(drawntreasure<2){
    ...
    int cardDrawn = state->hand[currentPlayer][state->handCount[currentPlayer]-1];//top card of hand is most recently drawn card.
      // BUG introduced: we forgot to check for silver cards.
                          ...
                          int currentPlayer)
{
  ...
  // BUG introduced: the last player is skipped.
...
int cardEffectMine(struct gameState *state, int handPos,
                   int currentPlayer, int choice1, int choice2)
{
  ...
  // BUG introduced: we use choice1 here instead of choice2.
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case mine:
      return cardEffectMine(state, handPos, currentPlayer, choice1, choice2);
    ...
    case smithy:
      return cardEffectSmithy(state, handPos, currentPlayer);

    case village:
      return cardEffectVillage(state, handPos, currentPlayer);
